...
/** Variaveis da atividade 6. Eleições Municipais.
 *  Esta variavel referencia ao container das informações dos politicos.
 *  Indicando o elemento de ID "VOTAR".
 * 
 * @type {HTMLElement}
 * 
 */
 ...
 let politicoContainer = document.getElementById("politicoContainer");

let politico1 = document.getElementById("")
...
VOTAR.addEventListener('click', function(){
    if(politicoContainer.style.display == 'none'){
    politicoContainer.style.display = "flex";
setTimeout(5000, function(){
    let resposta = prompt("INSIRA SEU VOTO: ")
    ...
    if(resposta == "12345"){
        ...
        politicoContainer.style.display = 'none'
    }
})